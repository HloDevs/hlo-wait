...
export default function Team({ memberImage, memberName, memberDesignation, memberSocial, memberLink }) {

  const router = useRouter();

  const redirect = () => {
    router.push(memberLink)
  }

  return (
    <Div className="cs-team cs-style1">
      <Div className="cs-member_thumb" onClick={redirect}>
